...
public class Translator {
	...
	private static final String ASCII_BAR = "%7C";
	private static final String MY_SITE = "http://www.kevingomara.com";
	private static final String TAG = "Translator";
	
	public static String translate(String text, String from, String to) throws Exception {
		try {
			StringBuilder url = new StringBuilder();
			url.append(URL_BASE).append(from).append(ASCII_BAR).append(to);
			...
			try {
				...
				String rawResult = makeResult(inStream);
