package com.kevingomara.helloformstuff;
...
public class HelloFormStuff extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Set an OnKeyListener for the EditText
		...
		// Set instance variables for the OnClickListeners for the Radio Buttons
		final RadioButton radio_red = (RadioButton) findViewById(R.id.radio_red);
		final RadioButton radio_blue = (RadioButton) findViewById(R.id.radio_blue);
		radio_red.setOnClickListener(radio_listener);
		radio_blue.setOnClickListener(radio_listener);

		// Set an OnClickListener for the Toggle
		...
		// Set an OnRatingBarChangeListener for the Rating Bar
